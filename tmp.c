...
main (int argc, char **argv)
{
  ...
  printf("%sBinaire result: ", ANSI_COLOR_RED);
  affichebin(ether_frame);
  printf("\tDecimal: %d%s\n", ether_frame, ANSI_COLOR_RESET);

  printf("%sBinaire result 12: ", ANSI_COLOR_RED);
  affichebin(ether_frame[12]);
  printf("\tDecimal: %d%s\n", ether_frame[12], ANSI_COLOR_RESET);

  printf("%sBinaire result 13: ", ANSI_COLOR_RED);
  affichebin(ether_frame[13]);
  printf("\tDecimal: %d%s\n", ether_frame[13], ANSI_COLOR_RESET);

  printf("%sBinaire result addition: ", ANSI_COLOR_RED);
  affichebin(ether_frame[12] << 8);
  printf("\tDecimal: %d%s\n", ether_frame[12] << 8, ANSI_COLOR_RESET);
